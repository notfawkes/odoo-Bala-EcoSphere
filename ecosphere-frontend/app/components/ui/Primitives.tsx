  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <motion.div
        ...
        className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl dark:bg-[#111E0E] dark:border dark:border-[#1E3319]"
      >
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-xl font-bold dark:text-[#E8F0E4]">{title}</h2>
          <button onClick={onClose} className="text-2xl text-[#6B7280] hover:text-black dark:hover:text-white">&times;</button>
        </div>
        {children}
      </motion.div>
    </div>

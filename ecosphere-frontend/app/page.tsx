  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#F7FAF5] text-[#1B1B1B] dark:bg-[#0F1A0D] dark:text-[#E8F0E4]">
      ...
      <main>
        <section className="mx-auto grid max-w-7xl items-center gap-12 px-5 pb-20 pt-16 md:px-8 lg:grid-cols-[1.05fr_.95fr] lg:pb-28 lg:pt-24">
          <div>
            ...
            <motion.p
              ...
              EcoSphere integrates sustainability into everyday business—so
              every team can make informed, accountable progress.
            </motion.p>
            <motion.div
              initial={{
                opacity: 0,
            ...
            <div className="mt-12 flex gap-8 border-t border-[#DDE8D6] pt-6 dark:border-[#1E3319]">
              <div>
                ...
                <p className="text-xs text-[#6B7280] dark:text-[#6B7B67]">
          ...
          <motion.div
            ...
            <div className="rounded-2xl bg-[#244E18] p-6 text-white">
              ...
              <div className="flex items-end justify-between">
                <div>
                  ...
                  <p className="mt-2 text-sm text-[#D5E6C9]">
                    Overall ESG score
                  </p>
                </div>
            ...
            <div className="mt-4 grid grid-cols-3 gap-3">
              ...
              <div key={a} className="rounded-xl bg-white p-4 dark:bg-[#162212]">
                  <p className="text-[10px] font-bold tracking-wider text-[#83907F] dark:text-[#6B7B67]">
                    {a}
                  </p>
                  <p className="mt-2 font-display text-4xl text-[#315b23] dark:text-[#8ECA3C]">
                    {b}
                  </p>
                  <div className="mt-3 h-1.5 rounded-full bg-[#EAF2E5] dark:bg-[#1E3319]">
                    <div
                    className="h-full rounded-full bg-[#7BBF34]"
                    style={{
                      width: `${b}%`
                    }} />
            ...
            <div className="mt-4 rounded-xl border border-white/70 bg-white/75 p-4 dark:border-[#1E3319] dark:bg-[#162212]/80">
              <div className="flex items-center justify-between">
                <p className="text-sm font-bold text-[#42523D] dark:text-[#C8E6B8]">
                  Carbon target
                </p>
        ...
        <section
          id="platform"
          className="border-y border-[#E6EFE0] bg-white py-20 dark:border-[#1E3319] dark:bg-[#111E0E]">
              ...
              <motion.div
                ...
                key={title as string}>
                  ...
                  <Card className="h-full p-6">
                    ...
                    <h3 className="mt-6 text-lg font-bold dark:text-[#E8F0E4]">
                      {title as string}
                    </h3>
                    <p className="mt-2 text-sm leading-6 text-[#6B7280] dark:text-[#8A9687]">
                      {copy as string}
                    </p>
                  </Card>
                </motion.div>
        ...
        <section id="workflow" className="mx-auto max-w-7xl px-5 py-20 md:px-8">
          <div className="flex flex-col justify-between gap-5 md:flex-row">
            <div>
              ...
              <h2 className="mt-3 font-display text-5xl leading-none tracking-wide">
                FROM SIGNAL TO IMPACT.
              </h2>
            </div>
            <p className="max-w-sm text-sm leading-6 text-[#6B7280] dark:text-[#8A9687]">
              A shared rhythm connects teams, evidence, actions, and reporting
        ...
        <section
          id="impact"
          className="bg-[#244E18] px-5 py-20 text-white md:px-8">
          
          <div className="mx-auto max-w-4xl text-center">
            <BarChart3Icon className="mx-auto text-[#BBDC12]" size={30} />
            <h2 className="mt-5 font-display text-6xl leading-none tracking-wide">
              MAKE PROGRESS VISIBLE.
            </h2>
            <p className="mx-auto mt-5 max-w-xl text-[#D5E6C9]">
              Move from annual compliance to an ESG practice your whole business
      ...
      <footer className="mx-auto flex max-w-7xl flex-col gap-3 px-5 py-8 text-xs text-[#758171] dark:text-[#6B7B67] md:flex-row md:justify-between md:px-8">
        <p>
          © 2026 EcoSphere. Integrating Sustainability into Everyday Business.
        </p>
